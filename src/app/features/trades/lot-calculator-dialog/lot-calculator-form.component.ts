...
export interface LotCalculatorFormInitialData {
...
@Component({
  selector: 'app-lot-calculator-form',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [ReactiveFormsModule, TranslatePipe, DecimalPipe, AppInputComponent, AppSelectComponent, AppButtonComponent],
  templateUrl: './lot-calculator-form.component.html',
  styleUrl: './lot-calculator-form.component.scss',
})
export class LotCalculatorFormComponent implements OnInit {
  ...
  readonly initialData = input<LotCalculatorFormInitialData>({});
  ...
  readonly form = this.fb.group({
    tradingAccountId: [null as string | null],
    ...
    tradingInstrumentId: [null as string | null],
    ...
    stopLossPrice: [null as number | null, Validators.min(Number.EPSILON)],
  ...
  ngOnInit(): void {
    ...
    this.form.patchValue({
      ...
      tradingInstrumentId: data.tradingInstrumentId ?? null,
